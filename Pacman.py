...
class Pacman(Character):
    ...
    def die(self):
        ...
        pacman_death_sfx.play() #changed sound
    ...
    def keyboard_input(self, key):
        ...
        if key == pygame.K_DOWN: self.keyboardMemory = DOWN
         #if key == 'right': self.keyboardMemory = RIGHT
         #elif key == 'left': self.keyboardMemory = LEFT
         #elif key == 'up': self.keyboardMemory = UP
         #elif key == 'down': self.keyboardMemory = DOWN
